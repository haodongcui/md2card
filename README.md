...
[在线使用](https://haodongcui.github.io/md2card/) · [打开工作台](https://haodongcui.github.io/md2card/app/) · [完整能力示例](./examples/complex-markdown/复杂排版与资源回归样例.md)
...
- [x] 舒展、技术平衡、紧凑三种密度预设，以及画布、正文、标题、技术块四类细调。
...
打开 [md2card 工作台](https://haodongcui.github.io/md2card/app/)，直接粘贴 Markdown 或导入一篇本地文件。默认的 **3:4 + 技术平衡 + 融合首卡** 已适合大多数技术笔记；遇到长公式或宽表格时，再进入“技术块”细调即可。

### 导入项目自带样例

项目内置了一篇真实的复杂排版样稿和三张 SVG 图片：

```text
examples/complex-markdown/
├── 复杂排版与资源回归样例.md
└── images/
    ├── architecture.svg
...
1. 导入 `复杂排版与资源回归样例.md`；也可以将文件拖入编辑区。
2. 检测到图片引用后，选择 `complex-markdown` 目录；或在“管理图片”点击“自动补齐（选择图片所在文件夹）”。
3. 确认三张 SVG 都已绑定，分别尝试不同画布比例、密度与主题。
4. 使用标准发布和高清原图各导出一次，检查页序、图片和表格是否一致。
...
视觉改动还应使用 [完整能力示例](./examples/complex-markdown/复杂排版与资源回归样例.md)，在 Chrome / Edge 中人工检查表格、长公式、多级标题、代码和三张本地图片的预览与导出。
