...
> 面向技术内容的纯前端 Markdown 图片卡片生成器。将公式、表格、代码和本地图片编排成可连续阅读、可直接发布的 PNG 卡片。

[在线使用](https://haodongcui.github.io/md2card/) · [打开工作台](https://haodongcui.github.io/md2card/app/) · [查看完整样例](./examples/Md2Card%20Example.md)

![Md2Card 产品预览](./public/og-cover.png)

**Md2Card** 适合将技术 Markdown 制作成小红书、知识笔记或长图卡片。它没有账号、没有后端、不会上传文章：解析、图片绑定、真实分页、预览、PNG 生成和 ZIP 下载均在当前浏览器完成。
...
| 技术内容 | KaTeX 公式、GFM 表格、代码与图片各自拥有合适的缩放、续页和样式规则 |
...
打开 [Md2Card 工作台](https://haodongcui.github.io/md2card/app/)，直接粘贴 Markdown 或导入一篇本地文件。
...
默认的 **3:4 + 技术平衡 + 融合首卡** 适合大多数技术笔记。遇到长公式或宽表格时，优先在“内容”分类调整对应项目，无需连带缩小普通正文。
...
为保证导出安全与一致，原始 HTML 会被忽略。内联图片、复杂 HTML 混排、脚注和 Mermaid 暂不属于稳定支持范围；复杂宽表和极长公式建议优先拆分内容或使用 2:3 技术长图。
